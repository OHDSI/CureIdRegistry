...
--Load person table
SELECT
    pe.person_id, pe.gender_concept_id, pe.year_of_birth, pe.month_of_birth, pe.day_of_birth, pe.birth_datetime, pe.race_concept_id, pe.ethnicity_concept_id, pe.location_id, pe.provider_id, pe.care_site_id, NULL
        as person_source_value, NULL as gender_source_value, pe.gender_source_concept_id, NULL as
...
SELECT d.drug_exposure_id, d.person_id, d.drug_concept_id, d.drug_exposure_start_date, d.drug_exposure_start_datetime, d.drug_exposure_end_date, d.drug_exposure_end_datetime, d.verbatim_end_date, d.drug_type_concept_id, d.stop_reason, d.refills, d.quantity, d.days_supply, d.sig, d.route_concept_id, d.lot_number, d.provider_id, d.visit_occurrence_id, d.visit_detail_id, NULL as drug_source_value, d.drug_source_concept_id, NULL as route_source_value, NULL as dose_unit_source_value
...
--Load Death table
SELECT death.person_id, death.death_date, death.death_datetime, death.death_type_concept_id, death.cause_concept_id, NULL as cause_source_value, death.cause_source_concept_id
...
SELECT DISTINCT
    o.observation_id, o.person_id, o.observation_concept_id, o.observation_date, o.observation_datetime, o.observation_type_concept_id, o.value_as_number, o.value_as_string, o.value_as_concept_id, o.qualifier_concept_id, o.unit_concept_id, o.provider_id, o.visit_occurrence_id, o.visit_detail_id, NULL as observation_source_value, o.observation_source_concept_id,
...
SELECT p.procedure_occurrence_id, p.person_id, p.procedure_concept_id, p.procedure_date, p.procedure_datetime, p.procedure_end_date, p.procedure_end_datetime, p.procedure_type_concept_id, p.modifier_concept_id, p.quantity, p.provider_id, p.visit_occurrence_id, p.visit_detail_id, NULL as procedure_source_value, p.procedure_source_concept_id, NULL as modifier_source_value
...
SELECT
    c.condition_occurrence_id, c.person_id, c.condition_concept_id, c.condition_start_date, c.condition_start_datetime, c.condition_end_date, c.condition_end_datetime, c.condition_type_concept_id, c.condition_status_concept_id, c.stop_reason, c.provider_id, c.visit_occurrence_id, c.visit_detail_id, NULL as condition_source_value, c.condition_source_concept_id,
...
SELECT DISTINCT
    v.visit_occurrence_id, v.person_id, v.visit_concept_id, v.visit_start_date, v.visit_start_datetime, v.visit_end_date, v.visit_end_datetime, v.visit_type_concept_id, v.provider_id, v.care_site_id,
...
SELECT dev.device_exposure_id, dev.person_id, dev.device_concept_id, dev.device_exposure_start_date, dev.device_exposure_start_datetime, dev.device_exposure_end_date, dev.device_exposure_end_datetime, dev.device_type_concept_id, dev.unique_device_id, dev.production_id, dev.quantity, dev.provider_id, dev.visit_occurrence_id, dev.visit_detail_id, NULL as device_source_value, dev.device_source_concept_id, dev.unit_concept_id, NULL as unit_source_value, dev.unit_source_concept_id
